...
@section('content')
<div class="header header-filter" style="background-image: url('{{ asset('img/madera1.jpg') }}');">
</div>
    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <form method="post" action="{{ url('/admin/categories') }}" enctype="multipart/form-data">
                ...
                <button class="btn btn-warning t-black">Registrar categoría</button>
                <a href="{{ url('/admin/categories') }}" class="btn btn-default t-black">Cancelar</a>
            </form>
        </div>
